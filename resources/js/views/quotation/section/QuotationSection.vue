...
<template>
    <div class="col-span-7 bg-white rounded-md shadow-md">
        ...
        >
            ...
            <router-link
                class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-emerald-500 text-white hover:bg-teal-600 focus:outline-hidden focus:bg-teal-600 disabled:opacity-50 disabled:pointer-events-none"
                :to="`/projects/${currentProject}/print`"
                target="_blank"
            >
                ...
                >
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-1">
                            <span class="mt-8 block text-center text-2xl"
                                >=</span
                            >
                        </div>
                        <div class="col-span-2">
