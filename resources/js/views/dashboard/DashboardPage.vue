    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
          ...
          >
            ...
            <div class="flex items-end justify-between mt-5">
              ...
              <span
                class="inline-flex items-center px-2.5 py-0.5 justify-center gap-1 rounded-full font-medium text-sm bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500"
                ><svg
                  class="fill-current"
                  width="1em"
                  height="1em"
          ...
          >
            ...
            <div class="flex items-end justify-between mt-5">
              ...
              <span
                class="inline-flex items-center px-2.5 py-0.5 justify-center gap-1 rounded-full font-medium text-sm bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500"
                ><svg
                  class="fill-current"
                  width="1em"
                  height="1em"
        ...
        >
            ...
            <div class="relative inline-block">
              <button class="dropdown-toggle">
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  class="text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 size-6"
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
          ...
          <div class="max-w-full overflow-x-auto custom-scrollbar">
            <div class="-ml-5 min-w-[650px] xl:min-w-full pl-2">
              <div class="" style="min-height: 195px">
                <div
                  id="apexchartsao8l1gge"
                  class="apexcharts-canvas apexchartsao8l1gge apexcharts-theme-"
                ...
                >
                  <svg
                    ...
                    height="180"
                  >
                    <foreignObject x="0" y="0" width="820" height="180"
                      ></foreignObject
                    >
                    <g
                    ...
                    >
                      <defs>
                        ...
                        <clipPath id="gridRectMaskao8l1gge">
                          <rect
                            width="758.3283843994141"
                            height="118.72999999999999"
                            x="-4"
                            y="-4"
                            rx="0"
                            ry="0"
                        ...
                        <clipPath id="gridRectBarMaskao8l1gge">
                          <rect
                            width="758.3283843994141"
                            height="118.72999999999999"
                            x="-4"
                        ...
                        <clipPath id="gridRectMarkerMaskao8l1gge">
                          <rect
                            width="750.3283843994141"
                            height="110.72999999999999"
                            x="0"
                            y="0"
                            rx="0"
                            ry="0"
                        ...
                        <clipPath id="forecastMaskao8l1gge"></clipPath>
                        <clipPath id="nonForecastMaskao8l1gge"></clipPath>
                      </defs>
                      <rect
                        width="24.38567249298096"
                        height="110.72999999999999"
                        x="0"
                        y="0"
                        rx="0"
                      ...
                      <g class="apexcharts-grid">
                        <g class="apexcharts-gridlines-horizontal">
                          <line
                            x1="0"
                            y1="27.682499999999997"
                            x2="750.3283843994141"
                            y2="27.682499999999997"
                            stroke="#e0e0e0"
                            stroke-dasharray="0"
                            stroke-linecap="butt"
                          ...
                          <line
                            x1="0"
                            y1="55.364999999999995"
                            x2="750.3283843994141"
                            y2="55.364999999999995"
                            stroke="#e0e0e0"
                            stroke-dasharray="0"
                            stroke-linecap="butt"
                            class="apexcharts-gridline"
                          ...
                          <line
                            x1="0"
                            y1="83.04749999999999"
                            x2="750.3283843994141"
                            y2="83.04749999999999"
                            stroke="#e0e0e0"
                            stroke-dasharray="0"
                            stroke-linecap="butt"
                            class="apexcharts-gridline"
                      ...
                      <g class="apexcharts-bar-series apexcharts-plot-series">
                        ...
                        >
                          <path
                            d="M 21.07084643681844 108.731 L 21.07084643681844 71.2244 C 21.07084643681844 68.7244 23.57084643681844 66.2244 26.07084643681844 66.2244 L 36.4565189297994 66.2244 C 38.9565189297994 66.2244 41.4565189297994 68.7244 41.4565189297994 71.2244 L 41.4565189297994 108.731 z "
                            fill="rgba(70,95,255,1)"
                            fill-opacity="1"
                            stroke="transparent"
                            stroke-opacity="1"
                            ...
                            index="0"
                            clip-path="url(#gridR

                            stroke-opacity="1"
                            ...
                            index="0"
                            clip-path="url(#gridRectBarMaskao8l1gge)"
                            pathTo="M 708.8718654696146 108.731 L 708.8718654696146 86.72659999999999 C 708.8718654696146 84.22659999999999 711.3718654696146 81.72659999999999 713.8718654696146 81.72659999999999 L 724.2575379625955 81.72659999999999 C 726.7575379625955 81.72659999999999 729.2575379625955 84.22659999999999 729.2575379625955 86.72659999999999 L 729.2575379625955 108.731 z "
                            pathFrom="M 708.8718654696146 108.731 L 708.8718654696146 108.731 L 729.2575379625955 108.731 L 729.2575379625955 108.731 L 729.2575379625955 108.731 L 729.2575379625955 108.731 L 729.2575379625955 108.731 L 708.8718654696146 108.731 z"
                            cy="79.72559999999999"
                            cx="767.3992308362324"
                            j="11"
                            val="112"
                            barHeight="31.004399999999997"
                            barWidth="24.38567249298096"
                          ></path>
                          <g class="apexcharts-bar-goals-markers">
                            <g
                              ...
                              clip-path="url(#gridRectMarkerMaskao8l1gge)"
                            ></g>
                            <g
                              className="apexcharts-bar-goals-groups"
                              class="apexcharts-hidden-element-shown"
      ...
      <div class="col-span-12 xl:col-span-5">
        ...
        >
          ...
          >
            ...
            <div class="relative">
              <div class="max-h-[330px]" id="chartDarkStyle">
                <div style="min-height: 158px">
                  <div
                    id="apexchartsxtp1bdm1l"
                    class="apexcharts-canvas apexchartsxtp1bdm1l apexcharts-theme-"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <defs>
                          <clipPath id="gridRectMaskxtp1bdm1l">
                            <rect
                              width="336"
                              height="334"
                              x="-3"
                          ...
                          <clipPath id="gridRectBarMaskxtp1bdm1l">
                            <rect
                              width="336"
                              height="334"
                              x="-3"
                          ...
                          <clipPath id="gridRectMarkerMaskxtp1bdm1l">
                            <rect
                              width="330"
                              height="328"
                              x="0"
                          ...
                          <clipPath id="forecastMaskxtp1bdm1l"></clipPath>
                          <clipPath id="nonForecastMaskxtp1bdm1l"></clipPath>
                        </defs>
                        <g class="apexcharts-radialbar">
                          <g>
                            <g class="apexcharts-tracks">
                              ...
                              >
                                <path
                                  d="M 27.027034314293246 151.92892962944927 A 138.5 138.5 0 0 1 302.97296568570675 151.92892962944936 "
                                  fill="none"
                                  fill-opacity="1"
                                  ...
                                  data:pathOrig="M 27.027034314293246 151.92892962944927 A 138.5 138.5 0 0 1 302.97296568570675 151.92892962944936 "
                                ></path>
                              </g>
                            </g>
                            <g>
                              ...
                              >
                                <path
                                  d="M 27.027034314293246 151.92892962944927 A 138.5 138.5 0 0 1 259.45677286865606 62.70751232574489 "
                                  fill="none"
                                  fill-opacity="0.85"
                                  ...
                                  index="0"
                                  j="0"
                                  data:pathOrig="M 27.027034314293246 151.92892962944927 A 138.5 138.5 0 0 1 259.45677286865606 62.70751232574489 "
                                ></path>
                              </g>
                              <circle
                                r="128"
              ...
              <span
                class="absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full bg-success-50 px-3 py-1 text-xs font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500"
                >+10%</span
              >
            </div>
            <p
              class="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base"
            >
        ...
        >
          <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
            ...
            <div class="flex items-start w-full gap-3 sm:justify-end">
              ...
              >
                <button
                  class="px-3 py-2 font-medium w-full rounded-md text-theme-sm hover:text-gray-900 dark:hover:text-white shadow-theme-xs text-gray-900 dark:text-white bg-white dark:bg-gray-800"
                >
                  Monthly</button
                ><button
                  class="px-3 py-2 font-medium w-full rounded-md text-theme-sm hover:text-gray-900 dark:hover:text-white text-gray-500 dark:text-gray-400"
                >
                  Quarterly</button
                ><button
                  class="px-3 py-2 font-medium w-full rounded-md text-theme-sm hover:text-gray-900 dark:hover:text-white text-gray-500 dark:text-gray-400"
          ...
          <div class="max-w-full overflow-x-auto custom-scrollbar">
            <div class="min-w-[1000px] xl:min-w-full">
              <div class="" style="min-height: 325px">
                <div
                  id="apexchartsv1ers04b"
                  class="apexcharts-canvas apexchartsv1ers04b apexcharts-theme-"
                  style="width: 1438px; height: 310px"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    version="1.1"
                    ...
                    height="310"
                  >
                    <foreignObject x="0" y="0" width="1438" height="310"
                      ></foreignObject
                    >
                    <rect
                      width="0"
                    ...
                    <g
                      class="apexcharts-yaxis"
                      rel="0"
                      transform="translate(17.983978271484375, 0)"
                    >
                      <g class="apexcharts-yaxis-texts-g">
                        <text
                          x="20"
                    ...
                    <g
                      class="apexcharts-inner apexcharts-graphical"
                      transform="translate(47.983978271484375, 30)"
                    >
                      <defs>
                        <clipPath id="gridRectMaskv1ers04b">
                          <rect
                            width="1374.3600311279297"
                            height="246.73000000000002"
                            x="-3"
                            y="-3"
                            rx="0"
                            ry="0"
                        ...
                        <clipPath id="gridRectBarMaskv1ers04b">
                          <rect
                            width="1374.3600311279297"
                            height="246.73000000000002"
                            x="-3"
                        ...
                        <clipPath id="gridRectMarkerMaskv1ers04b">
                          <rect
                            width="1368.3600311279297"
                            height="240.73000000000002"
                            x="0"
                            y="0"
                            rx="0"
                            ry="0"
                        ...
                        <clipPath id="forecastMaskv1ers04b"></clipPath>
                        <clipPath id="nonForecastMaskv1ers04b"></clipPath>
                        <linearGradient
                          x1="0"
                          y1="0"
                          x2="0"
                        ...
                        >
                          <stop
                            stop-opacity="0.55"
                            stop-color="rgba(156,185,255,0.55)"
                            offset="0"
                          ></stop>
                          <stop
                            stop-opacity="0"
                            stop-color="rgba(206,220,255,0)"
                            offset="1"
                          ></stop>
                          <stop
                            stop-opacity="0"
                      ...
                      <g class="apexcharts-area-series apexcharts-plot-series">
                        ...
                        >
                          <path
                            d="M 0 67.40439999999998 L 124.39636646617544 57.775199999999984 L 248.79273293235087 77.03359999999998 L 373.1890993985263 86.6628 L 497.58546586470175 72.219 L 621.9818323308772 81.84819999999999 L 746.3781987970526 77.03359999999998 L 870.774565263228 43.331399999999974 L 995.1709317294035 19.258399999999995 L 1119.5672981955788 38.51679999999999 L 1243.9636646617544 9.629199999999969 L 1368.3600311279297 14.443799999999982 L 1368.3600311279297 240.73000000000002 L 0 240.73000000000002z"
                            ...
                            index="0"
                            clip-path="url(#gridRectMaskv1ers04b)"
                            pathTo="M 0 67.40439999999998 L 124.39636646617544 57.775199999999984 L 248.79273293235087 77.03359999999998 L 373.1890993985263 86.6628 L 497.58546586470175 72.219 L 621.9818323308772 81.84819999999999 L 746.3781987970526 77.03359999999998 L 870.774565263228 43.331399999999974 L 995.1709317294035 19.258399999999995 L 1119.5672981955788 38.51679999999999 L 1243.9636646617544 9.629199999999969 L 1368.3600311279297 14.443799999999982 L 1368.3600311279297 240.73000000000002 L 0 240.73000000000002z"
                            pathFrom="M 0 240.73000000000002 L 0 240.73000000000002 L 124.39636646617544 240.73000000000002 L 248.79273293235087 240.73000000000002 L 373.1890993985263 240.73000000000002 L 497.58546586470175 240.73000000000002 L 621.9818323308772 240.73000000000002 L 746.3781987970526 240.73000000000002 L 870.774565263228 240.73000000000002 L 995.1709317294035 240.73000000000002 L 1119.5672981955788 240.73000000000002 L 1243.9636646617544 240.73000000000002 L 1368.3600311279297 240.73000000000002z"
                          ></path>
                          <path
                            d="M 0 202.21320000000003 L 124.39636646617544 211.8424 L 248.79273293235087 192.584 L 373.1890993985263 202.21320000000003 L 497.58546586470175 187.76940000000002 L 621.9818323308772 202.21320000000003 L 746.3781987970526 173.3256 L 870.774565263228 144.438 L 995.1709317294035 134.80880000000002 L 1119.5672981955788 125.1796 L 1243.9636646617544 96.292 L 1368.3600311279297 105.9212"
                            fill="none"
                            fill-opacity="1"
                            stroke="#9cb9ff"
                            stroke-opacity="1"
           ...
           a 0,0 0 1,0 -0,0"
                                ...
                                cy="0"
                                shape="circle"
                                class="apexcharts-marker wh63k3mld no-pointer-events"
                                default-marker-size="0"
                              ></path>
                            </g>
                          </g>
      ...
      <div class="col-span-12 xl:col-span-5">
        ...
        >
          ...
          <div
            class="px-4 py-6 my-6 overflow-hidden border border-gary-200 rounded-2xl dark:border-gray-800 sm:px-6"
          >
            <div
              id="mapOne"
            ...
            >
              <div class="_u5cITtZnGk9D_6uoElx">
                <div
                  class="jvectormap-container"
                  style="background-color: transparent"
                >
                  <svg width="554" height="212">
                    <defs></defs>
                    <g
                      transform="scale(0.4810459819421187) translate(125.82852866096631, 0)"
                    >
                      <path
                    ...
                    <g>
                      <circle
                        data-index="0"
                        cx="136.96236572603556"
                        cy="89.99425980053553"
                        fill="#465FFF"
                        stroke="#383f47"
                        fill-opacity="1"
                        stroke-width="1"
                      ...
                      <circle
                        data-index="1"
                        cx="351.8359292601334"
                        cy="111.69430986976882"
                        fill="#465FFF"
                        stroke="#505050"
                        fill-opacity="1"
                        stroke-width="1"
                      ...
                      <circle
                        data-index="3"
                        cx="401.80274722224624"
                        cy="167.83018499870755"
                        fill="#465FFF"
                        stroke="#505050"
                        fill-opacity="1"
                        stroke-width="1"
                  ...
                  <div
                    class="jvectormap-legend-cnt jvectormap-legend-cnt-h"
                  ></div>
                  <div
                    class="jvectormap-legend-cnt jvectormap-legend-cnt-v"
                  ></div>
                </div>
              </div>
            </div>
        ...
        >
          ...
          <div class="max-w-full overflow-x-auto">
            <table class="min-w-full undefined">
              <thead class="border-gray-100 dark:border-gray-800 border-y">
                <tr>
                  <th
              ...
              <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                ...
                <tr class="">
                  ...
                  >
                    <span
                      class="inline-flex items-center px-2.5 py-0.5 justify-center gap-1 rounded-full font-medium text-theme-xs bg-warning-50 text-warning-600 dark:bg-warning-500/15 dark:text-orange-400"
                      >Pending</span
                    >
                  </td>
                </tr>
                ...
                <tr class="">
                  ...
                  >
                    <span
                      class="inline-flex items-center px-2.5 py-0.5 justify-center gap-1 rounded-full font-medium text-theme-xs bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500"
                      >Canceled</span
                    >
                  </td>
                </tr>
